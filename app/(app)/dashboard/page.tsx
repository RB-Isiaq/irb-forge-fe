...
export default function DashboardPage() {
  return (
    <div>
      ...
      <p className="text-[14px] text-text-muted mb-8">Your overview across all organizations.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {["Organizations", "Active programs", "Pending invitations"].map((label) => (
          <div key={label} className="rounded-[12px] bg-surface border border-border p-5">
