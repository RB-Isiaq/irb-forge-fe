...
import type { Invitation, InvitationPreview, SendInvitationPayload, AcceptInvitationPayload, DeclineInvitationPayload } from "../model/types";

export const invitationApi = {
  send:        (slug: string, data: SendInvitationPayload) => apiPost<Invitation>(`/organizations/${slug}/invitations`, data),
