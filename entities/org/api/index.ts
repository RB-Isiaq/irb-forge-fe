...
import type { Organization, CreateOrganizationPayload, UpdateOrganizationPayload } from "../model/types";
...
export const orgApi = {
  ...
  update: (slug: string, data: UpdateOrganizationPayload) => apiPatch<Organization>(`/organizations/${slug}`, data),
