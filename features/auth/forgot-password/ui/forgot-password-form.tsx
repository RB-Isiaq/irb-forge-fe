  ...
  return (
    <Card>
      <CardContent className="pt-6 text-center">
        ...
        <Link href="/login" className="text-[13px] text-primary font-medium hover:underline">Back to sign in</Link>
      </CardContent>
    </Card>
  );
}
...
export function ForgotPasswordForm() {
  ...
  async function onSubmit(data: FormData) {
    try { await userApi.forgotPassword(data); } catch { /* intentional */ }
    setSent(true);
  }
  ...
  return (
    <Card>
      <CardContent className="pt-6">
        ...
        <p className="text-[14px] text-text-muted mb-6">Enter your email and we&apos;ll send a reset link.</p>
